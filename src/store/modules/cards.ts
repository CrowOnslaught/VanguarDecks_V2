...
const mutations = {
    ...
    SET_FILTERS(state: any,  data: any) {
        state.filters = {
            filterCards: state.filters.cards,
            name:  data.name != undefined? data.name : state.filters.name,
            skill :data.skill != undefined? data.skill : state.filters.skill,
            nations: data.nations != undefined? data.nations :  state.filters.nations,
            grades: data.grades != undefined? data.grades :  state.filters.grades,
            power: data.power != undefined? data.power :  state.filters.power,
            shield: data.shield != undefined? data.shield :  state.filters.shield,
            abilities: data.abilities != undefined? data.abilities :  state.filters.abilities,
            race: data.race != undefined? data.race :  state.filters.race,
            sets: data.sets != undefined? data.sets :  state.filters.sets,
            keywords: data.keywords != undefined? data.keywords :  state.filters.keywords,
            types:data.types != undefined? data.types : state.filters.types,
            trigger: data.trigger != undefined? data.trigger : state.filters.trigger,
            newFilters: true,
            order: data.order != undefined? data.order :  state.filters.order,
        };
    },
